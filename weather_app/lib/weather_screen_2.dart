...
class _WeatherScreenSeccondState extends State<WeatherScreenSeccond> {
  static const String cityName = 'Copenhagen';
  static const String countryName = 'Denmark';
  static final String _apiurl =
      'https://api.openweathermap.org/data/2.5/forecast?q=$cityName,$countryName&APPID=$keyAPI';
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final currentKelvinTemp = currentForecastData['main']['temp'];
          final double currentTemp = currentKelvinTemp - 273.15;
          ...
          final double currentTermicalSensation =
              (currentForecastData['main']['feels_like']) - 273.15;
                ...
                Row(
                  ...
                  children: [
                    ...
                    AdditionalInfoItem(
                      ...
                      label: 'Sensation',
                      value: '${currentTermicalSensation.toStringAsFixed(0)}°C',
                    ),
                  ],
                ),
